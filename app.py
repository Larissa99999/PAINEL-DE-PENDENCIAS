...
nf_cols = [c for c in ['Solicitante','Comprador','Fornecedor','Nº Nota','Nº PC','Controle','Valor','Dt Emissão','Dt Entrega PC','Vencimento','⚠️ Prazo','Filial','Chave Sefaz','Justificativa','Observacao','Prazo_Resolucao','Responsavel','🔍 PC','Tipo'] if c in df_nfs.columns]
...
pc_cols = [c for c in ['Solicitante','Comprador','Fornecedor','Nº PC','Controle','Valor','Dt Emissão','Dt Entrega PC','Vencimento','⚠️ Prazo','Filial','Status','Justificativa','Observacao','Prazo_Resolucao','Responsavel','Tipo'] if c in df_pcs.columns]
