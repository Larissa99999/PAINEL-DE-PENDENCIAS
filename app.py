    ...
    if len(_responsaveis) > 0:
        ...
        for i, resp in enumerate(_responsaveis):
            ...
            for _, _r in _pend_resp.iterrows():
                ...
                linha = f"  - {_forn} | PC:{_pc_display} | NF:{_nota_display} | {_valor} | Venc:{_venc}{_outro_resp}"
            ...
            if _pcs_pendentes:
                ...
                for _, _r in _pend_resp.iterrows():
                    ...
                    linha = f"  - {_forn} | PC:{_pc_display} | NF:{_nota_display} | {_valor} | Venc:{_venc_fmt}{_outro2}"
...
Controle de Pendências"""
            ...
            _subject_short = f"Pendências em atraso — {_n} processos"
            _url_outlook = (
