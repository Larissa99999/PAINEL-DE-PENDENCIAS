    ...
    if len(_responsaveis) > 0:
        ...
        for i, resp in enumerate(_responsaveis):
            ...
            for _, _r in _pend_resp.iterrows():
                ...
                linha = f"  • {_forn} | PC: {_pc_display} | NF: {_nota_display} | Valor: {_valor} | Emissão: {fmt_data(_r.get('Dt Emissão', ''))} | Prev. Entrega: {_entrega} | Venc: {_venc}"
            ...
            if _pcs_pendentes:
                ...
                for _, _r in _pend_resp.iterrows():
                    ...
                    linha = f"  • {_forn} | PC: {_pc_display} | NF: {_nota_display} | Valor: {_valor} | Prev. Entrega: {_entrega_fmt} | Venc: {_venc_fmt}"
