...
show_cols = [c for c in ['Tipo','Solicitante','Comprador','Fornecedor','Nº Nota','Nº PC','Valor','Dt Emissão','Vencimento','Filial','Controle','Chave Sefaz','Status','Justificativa','Observacao','Prazo_Resolucao','Responsavel'] if c in df_display.columns]
...
show_cols = [c for c in ['Tipo','Solicitante','Comprador','Fornecedor','Nº Nota','Nº PC','Valor','Dt Emissão','Vencimento','⚠️ Vencimento','Filial','Controle','Chave Sefaz','Status','Justificativa','Observacao','Prazo_Resolucao','Responsavel'] if c in df_display.columns]
        ...
        for i, resp in enumerate(_responsaveis):
            ...
            if _pcs_pendentes:
                ...
                for _, _r in _pend_resp.iterrows():
                    ...
                    linha = f"  • {_forn} | PC: {_pc_display} | NF: {_nota_display} | Valor: {_valor} | Venc: {_venc_fmt}"
